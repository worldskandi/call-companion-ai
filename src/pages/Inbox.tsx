...
const Inbox = () => {
  ...
  const [selectedDraft, setSelectedDraft] = useState<{ emailId: string; fromEmail: string; fromName: string; subject: string } | null>(null);
        ...
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              {selectedDraft && (
                <span className="text-muted-foreground"> • An: {selectedDraft.fromEmail}</span>
              )}
            </DialogDescription>
          </DialogHeader>
            ...
            <div className="flex items-center gap-2 justify-end">
              ...
              <Button 
                ...
                onClick={async () => {
                  ...
                  await saveDraft({
                    originalEmailId: selectedDraft.emailId,
                    originalFromEmail: selectedDraft.fromEmail,
                    originalFromName: selectedDraft.fromName,
                    originalSubject: selectedDraft.subject,
                    replySubject: draft?.replySubject || `Re: ${selectedDraft.subject}`,
