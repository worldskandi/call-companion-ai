...
const Footer = () => {
  return (
    <footer className="bg-[#F5F8FC] border-t border-[#3B82F6]/10 py-16">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          <div className="lg:col-span-1">
            <div className="flex items-center gap-1 mb-4">
              ...
              <span className="font-bold text-2xl tracking-tight text-[#1E293B]">Beavy <span className="text-[#3B82F6]">AI</span></span>
            </div>
            ...
            <div className="flex gap-3">
              {[Twitter, Linkedin, Github].map((Icon, i) => (
                <button
                  key={i}
                  className="w-10 h-10 rounded-lg bg-white border border-[#3B82F6]/10 flex items-center justify-center hover:bg-[#3B82F6]/5 transition-colors shadow-sm"
                >
          ...
          <div>
            ...
            <div className="flex gap-2">
              <Input
                ...
                className="bg-white border-[#3B82F6]/15 text-[#1E293B] placeholder:text-[#94A3B8]"
              />
        ...
        <div className="pt-8 border-t border-[#3B82F6]/10 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-[#94A3B8]">
            © 2025 BEAVY. Alle Rechte vorbehalten.
          </p>
          <div className="flex flex-wrap gap-6 text-sm text-[#94A3B8]">
            <a href="#" className="hover:text-[#3B82F6] transition-colors">Datenschutz</a>
            <a href="#" className="hover:text-[#3B82F6] transition-colors">AGB</a>
            <a href="#" className="hover:text-[#3B82F6] transition-colors">Impressum</a>
            <a href="#" className="hover:text-[#3B82F6] transition-colors">Cookie-Einstellungen</a>
          </div>
        </div>
      </div>
    </footer>
