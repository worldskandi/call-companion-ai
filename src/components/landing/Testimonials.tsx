...
const testimonials = [
  {
    name: 'Thomas Müller', role: 'CEO, TechStart GmbH',
...
const Testimonials = () => {
  return (
    <section id="über-uns" className="py-16 relative bg-gradient-to-b from-[#F0F4FA] via-[#E8F0FE] to-[#F0F4FA]">
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[400px] bg-[#3B82F6]/5 rounded-full blur-[120px]" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {testimonials.map((testimonial, index) => (
            <motion.div
              ...
              className="group"
            >
              <div className="h-full p-8 relative overflow-hidden bg-white/80 backdrop-blur-xl border border-[#3B82F6]/10 rounded-2xl hover:bg-white hover:border-[#3B82F6]/20 hover:shadow-lg hover:shadow-[#3B82F6]/5 transition-all duration-300">
                ...
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-full bg-[#3B82F6]/8 flex items-center justify-center text-[#3B82F6] font-bold">
        ...
        >
          ...
          <div className="flex flex-wrap items-center justify-center gap-8">
            {['TechCorp', 'InnovateCo', 'GlobalTech', 'FutureLabs', 'NextGen'].map((company, i) => (
              <div key={i} className="text-2xl font-bold text-[#3B82F6]/10">
                {company}
              </div>
            ))}
          </div>
