...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-[#3b5998]/40 via-[#4a6fa5]/30 to-transparent pointer-events-none" />
      ...
      <div className="absolute inset-0 pointer-events-none bg-[radial-gradient(ellipse_at_center,transparent_40%,rgba(200,215,240,0.4)_100%)]" />
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/50 backdrop-blur-2xl border border-white/40 shadow-lg shadow-blue-500/10 mb-8"
          >
